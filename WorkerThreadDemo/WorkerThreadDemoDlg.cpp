...
BEGIN_MESSAGE_MAP(CWorkerThreadDemoDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON_RunNotepad, &CWorkerThreadDemoDlg::OnClickedButtonRunnotepad)
END_MESSAGE_MAP()


// CWorkerThreadDemoDlg 메시지 처리기
...
void CWorkerThreadDemoDlg::OnClickedButtonRunnotepad()
{
